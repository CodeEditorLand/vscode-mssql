...
gulp.task(
	"ext:bundle-src",
	gulp.series(generateExtensionBundle, () =>
		transformExtensionLocalization([
...
gulp.task(
	...
	gulp.series(
		generateReactWebviewsBundle,
		function transformReactWebviewsLocalization() {
...
gulp.task(
	"ext:localization",
	gulp.series(
		"ext:localization:generate-eng-package.nls",
